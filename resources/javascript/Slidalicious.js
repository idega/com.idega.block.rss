  ...
  setOptions: function(options) {
    this.options = Object.extend({
      ...
      setSlide: function(slide,position){
            slide.image.style.background = 'url('+this.images[position]+' ) no-repeat';
      ...
      initializeSlideshow: function(){
            ...
            this.next_slide.image =  document.createElement("DIV");
            this.next_slide.image.innerHTML = '&nbsp;';  
            this.next_slide.image.id = 'nextSlide';  
            
            this.current_slide.image = document.createElement("DIV");           
            this.current_slide.image.innerHTML = '&nbsp;';
            this.current_slide.image.id= 'currentSlide';
